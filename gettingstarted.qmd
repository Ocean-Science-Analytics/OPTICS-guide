...
[OPTICS Insight](https://envision.shinyapps.io/OPTICSInsight/) requires credentials to the web-hosted tool. Once credentials are issues, the tool can be accessed from the OPTICS Insight server.
